...
const DoctorLogin = () => {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`/api/login`, { email, password, role: "doctor" })
      .then((res) => {
        if (res.status === 200) {
  ...
  return (
    <div className="px-32 py-10 h-[90vh] flex items-center justify-center text-center">
      ...
      >
        <h1 className="font-bold mb-5 text-xl">Doctor Login</h1>
        <input
          type="email"
        ...
        />
        <button className="btn btn-primary text-secondary">Login as Doctor</button>
        <p>
